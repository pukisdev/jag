app.controller('customerController', function($scope, $http, API_URL) {
  ...
  $scope.totalItems = 0;
  // $scope.subUrl = 'pms/customer';
  $scope.subUrl = '/mst/pms/customer';
  ...
  $scope._token = {};
    ...
    $scope.toggle = function(modalstate, id){
      ...
      switch(modalstate){
        ...
        break;
        case 'edit' :
          var _url = $scope._token['url']+ $scope.subUrl+"/"+id+'?_token='+$scope._token['token']+'&_e='+$scope._token['e'];
    ...
    $scope.save = function(modalstate, id){
      ...
      $http({
        'method'  : _method,
        'url'   : _url+'?_token='+$scope._token['token']+'&_e='+$scope._token['e'], 
        // 'url'     : _url,
    ...
    $scope.confirmDelete = function(_data, _index){
      ...
      if(isConfirmDelete){
        var _url = $scope._token['url']+ $scope.subUrl+'/'+_data.id_customer+'?_token='+$scope._token['token']+'&_e='+$scope._token['e'];
...
*/
  function getResultsPage(pageNumber) {
      ...
      var _url = $scope._token['url']+ $scope.subUrl+'?_token='+$scope._token['token']+'&_e='+$scope._token['e'];

      if(! $.isEmptyObject($scope.libraryTemp)){
        $http({
          'method'  : 'GET',
          // 'url'   : 'http://lumen.api/mst/pms/customer?_token='+$scope._token['token']+'&_e='+$scope._token['e']+'&search='+$scope.searchText+'&page='+pageNumber 
          // 'url'   : $scope._token['url']+'/mst/pms/customer?_token='+$scope._token['token']+'&_e='+$scope._token['e']+'&search='+$scope.searchText+'&page='+pageNumber 
        ...
        $http({
          'method'  : 'GET',
          // 'method'  : 'JSONP',
          // 'url'   : 'http://lumen.api/mst/pms/customer?_token='+$scope._token['token']+'&_e='+$scope._token['e']+'&page='+pageNumber 
          // 'url'   : $scope._token['url']+'/mst/pms/customer?_token='+$scope._token['token']+'&_e='+$scope._token['e']+'&page='+pageNumber 
          'url'   : _url+'&_e='+$scope._token['e']+'&page='+pageNumber 
        }).success(function(response){
          // console.log(response);
          $scope._data     = response.data;
          $scope.totalItems   = response.total;
...
app.directive('modalCustomer', function (){
    return{
        restirct    : 'A',
        templateUrl : '/assets/ng/views/modalCustomer.html',
    };
});
